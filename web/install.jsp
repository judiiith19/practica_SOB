    ...
    <body>
        ...
        <%
            ...
            String data[] = new String[]{
                ...
                "INSERT INTO " + schema + ".TOPIC VALUES (NEXT VALUE FOR TOPIC_GEN, 'History')",
                "INSERT INTO " + schema + ".TOPIC VALUES (NEXT VALUE FOR TOPIC_GEN, 'Health')",
                ...
                "INSERT INTO " + schema + ".ARTICLE (ID, CONTENT, IMAGE_URL, IS_PUBLIC, PUBLISHED_DATE, SUMMARY, TITLE, VIEWS, AUTHOR_ID) "
                    + "VALUES (NEXT VALUE FOR CUSTOMER_GEN, 'Text del contingut del article 2.', 'https://acortar.link/b84Ree', FALSE, '2024-12-04 18:56:00', 'Resum article 2.', 'Titol del article 2.', 0, 1)"
            };
